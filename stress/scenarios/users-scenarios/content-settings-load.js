...
export default function () {
  ...
  const response = http.get(`${BASE_URL}/users/me/content-settings`, {
    headers: {
      Authorization: `Bearer ${tokens[__VU]}`,
    },
  });

  console.log("content-settings status: " + response.status);
  console.log("content-settings body: " + response.body);
